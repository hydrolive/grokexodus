...
- Visual caves: remesh **only edited chunks** (marching cubes). Punch **2 m and 8 m** quads whose stamp sample is **authoritative air** (or a mound), 3×3 samples per quad. Do not punch whole saved pages. Do not leave the 8 m disk as an undiggable lid.
