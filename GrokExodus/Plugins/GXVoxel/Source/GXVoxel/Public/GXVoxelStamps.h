...
struct FGXPlanetStampParams
{
	...
	static FGXPlanetStampParams Earth()
	{
		...
		P.MountainFreq = 90.0f;   // ~4.2 km ranges — visible on the clipmap
		P.DetailFreq = 2400.0f;  // ~160 m ripples
		P.MoistureFreq = 2.4f;
		P.ScarFreq = 4.5f;
		...
		P.SeaLevelBias = 0.0f;
		P.PlateFreq = 2.2f;
		P.HillFreq = 400.0f;     // ~940 m rolling hills
		P.RiverFreq = 180.0f;
		P.CanyonFreq = 70.0f;
		P.PlateauFreq = 12.0f;   // ~31 km highland envelope
		P.LocalRidgeFreq = 1800.0f; // ~210 m walkable undulation
		P.LocalGullyFreq = 3200.0f;
		P.VolcanoFreq = 8.0f;
		P.ValleyAmp = 0.04f;
		P.CanyonAmp = 0.03f;
